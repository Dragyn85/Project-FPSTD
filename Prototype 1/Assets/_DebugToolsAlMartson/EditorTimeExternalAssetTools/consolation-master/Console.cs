...
namespace Consolation
{
    ...
    class Console : MonoBehaviour
    {
        ...
        /// <summary>
        /// Collapse repeated Log entries into just one.
        /// </summary>
        [Tooltip("Collapse repeated Log entries into just one.")]
        [SerializeField]
        private bool _collapseRepeatedLogEntriesUserDecision = true;
        ...
        void Awake()
        {
            ...
            if (_collapseRepeatedLogEntriesUserDecision)
            {
                isCollapsed = true;
            }
        }
